...
- This helps us find the percentage values of revenue and customer count of the `customer_status` of that `cohort_year` makes up to the total revenue and total customer count of the `cohort_year`.
